...
describe('getWeekDates', () => {
  ...
  it('주의 끝(일요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    const weekDates = getWeekDates(new Date('2025-02-09'));
    expect(weekDates).toEqual([
      new Date('2025-02-09'),
      new Date('2025-02-10'),
      new Date('2025-02-11'),
...
describe('formatWeek', () => {
  it('월의 중간 날짜에 대해 올바른 주 정보를 반환한다', () => {
    const week = formatWeek(new Date('2025-02-14'));
    expect(week).toBe('2025년 2월 2주');
  });

  it('월의 첫 주에 대해 올바른 주 정보를 반환한다', () => {
    const week = formatWeek(new Date('2025-02-02'));
    expect(week).toBe('2025년 2월 1주');
  });
...
describe('formatDate', () => {
  ...
  it('day 파라미터가 제공되면 해당 일자로 포맷팅한다', () => {
    expect(formatDate(new Date('2025-02-01'), 10)).toBe('2025-02-10');
  });
